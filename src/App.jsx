...
[지금 너에게 말 거는 상대]
${senderDesc}${relNote}${worldBridgeBlock(peerChar || { name: peerName, persona: peer?.persona }, senderChar || { name: meName, persona: ownerPersona })}
...
${relationHint ? `${listener.name}와의 관계: ${relationHint}` : `${listener.name}와 특별한 관계 없음.`}${worldBridgeBlock(speaker, listener)}
