...
OpenRouter keys live only on the backend. The old Vercel serverless `/api/generate` handler has been replaced by FastAPI.
...
- `OPENROUTER_API_KEY`
- `OPENROUTER_MODEL_FAST`, `OPENROUTER_MODEL_GOOD`
