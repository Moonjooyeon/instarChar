...
def test_auto_post_accepts_only_supported_intervals(monkeypatch: MonkeyPatch) -> None:
    ...
    with make_test_client() as client:
        ...
        accepted_twelve_hourly = client.patch("/api/characters/char-1/auto-post", json={"enabled": True, "interval_seconds": 43200})
    ...
    assert accepted_twelve_hourly.status_code == 200
