...
class Settings(BaseSettings):
    ...
    google_play_iap_enabled: bool = False
    google_play_iap_purchase_enabled: bool = False
    google_play_iap_purchase_rollout_percent: int = 0
    google_play_iap_package_name: str = "com.ashwoodfriends.alive"
    google_play_iap_service_account_json_path: str = "/run/secrets/google-play/service-account.json"
    google_play_iap_subject_hmac_key: str = ""
    google_play_rtdn_enabled: bool = False
    google_play_rtdn_audience: str = ""
    google_play_rtdn_push_service_account_email: str = ""
    google_play_iap_credit_5000_product_id: str = ""
    google_play_iap_credit_10000_product_id: str = ""
    google_play_iap_credit_30000_product_id: str = ""
    google_play_iap_credit_50000_product_id: str = ""
    google_play_iap_credit_100000_product_id: str = ""
    app_store_iap_enabled: bool = False
    app_store_iap_purchase_enabled: bool = False
    app_store_iap_purchase_rollout_percent: int = 0
    app_store_iap_bundle_id: str = "com.ashwoodfriends.alive"
    app_store_iap_app_apple_id: int = 0
    app_store_iap_root_certificate_paths: str = ""
    app_store_iap_online_checks_enabled: bool = True
    app_store_iap_subject_hmac_key: str = ""
    app_store_iap_credit_5000_product_id: str = "ALIVE_CREDITS_500"
    app_store_iap_credit_10000_product_id: str = "ALIVE_CREDITS_1000"
    app_store_iap_credit_30000_product_id: str = "ALIVE_CREDITS_3150"
    app_store_iap_credit_50000_product_id: str = "ALIVE_CREDITS_5500"
    app_store_iap_credit_100000_product_id: str = "ALIVE_CREDITS_11500"
