...
CREDIT_POLICY_VERSION = "credit-2026-08-v1"
ENERGY_POLICY_VERSION = "energy-2026-08-v1"
...
FLOW_POLICIES: dict[str, FlowPolicy] = {
    ...
    "direct_dm_pro": FlowPolicy("direct_dm_pro", 5, 25, "pro", "Pro 대화", 24000, 2048, 256, 20, energy_allowed=False, bonus_allowed=False),
    "direct_dm_pro_story": FlowPolicy("direct_dm_pro_story", 7, 30, "pro", "Pro 서사형", 50000, 4096, 1024, 10, energy_allowed=False, bonus_allowed=False),
