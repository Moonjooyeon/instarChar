...
| Services                 | `backend/app/services/`                     | OAuth, Toss/native login, OpenRouter generation, media storage/validation, safety, account deletion, feed generation, and autonomous scheduling   |
...
| `POST`   | `/api/ai/generate`                                                      | `ai.py`                | Generate character, feed, DM, or analysis text through OpenRouter                                 |
