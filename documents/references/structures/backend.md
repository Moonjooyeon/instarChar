...
| Services                 | `backend/app/services/`                     | OAuth, Toss/native login, MonoGPT Gemini generation with Cafe24 fallback, media storage/validation, safety, account deletion, feed generation, and autonomous scheduling   |
...
| `POST`   | `/api/ai/generate`                                                      | `ai.py`                | Generate character, feed, DM, or analysis text through MonoGPT Gemini with Cafe24 fallback        |
