...
| --- | --- | --- | --- | --- | --- |
| TOS-01 | P0 | 출시 범위와 정책 질의 확정 | MVP 포함·제외 기능, AI/UGC/DM 분류, 외부 법률 링크 허용 범위를 1페이지로 확정하고 채널톡 답변을 기록한다. | 없음 | 0.5~2일 |
...
| 단계 | 산출물 | 출시 게이트 |
| --- | --- | --- |
| 1. 정책·범위 | MVP 범위표, 채널톡 질의·답변 기록 | AI 캐릭터 대화와 공개 기능의 허용 범위가 명확하다. |
...
- 토스 샌드박스에서 검증하지 않았거나, 공개/공유/DM 기능의 정책 분류가 미해결이다.
...
1. TOS-01에서 MVP 범위를 확정한다: **공개 탐색·공유·결제는 첫 출시에서 제외**한다.
...
- [기존 분석](../reports/앱인토스/report_apps-in-toss-total-change-analysis_2026-07-29.md)
- [출시 가드레일](../reports/앱인토스/report_apps-in-toss-launch-guardrails_2026-07-29.md)
