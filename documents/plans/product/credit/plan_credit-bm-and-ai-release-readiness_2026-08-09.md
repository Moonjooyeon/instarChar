...
| 상품 기준 | 4,950원 500C, 9,900원 1,000C, 29,700원 3,150C, 49,500원 5,500C, 99,000원 11,500C |
...
2026-08-11 Apps in Toss 콘솔의 공급가에 VAT가 반영되면서 실제 판매가는 초기 명목 가격보다 1% 낮게 확정됐다. 기존 명목 가격으로 계산한 수익성 표는 실제 판매가 기준으로 다시 승인해야 한다.
