...
| AIT 업로드·상품 5개 등록·최소 지원 버전 선택 | 중간 | 1~2시간 | 외부 작업 대기 | 콘솔 검토 대기 |
...
| 내부 상품 | 상품 유형 | 상품명 초안 | 설명 초안 | 상품 이미지 | 공급가 | 최소 지원 버전 | 최초 노출 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `credit-5000` | 소모품 | `크레딧 500C` | `얼라이브 AI 기능에 사용하는 500C` | [credit-500.png](../../../qa/evidence/apps-in-toss-iap-products/credit-500.png) | 승인 대기 | 업로드한 IAP 번들 | OFF |
| `credit-10000` | 소모품 | `크레딧 1,000C` | `얼라이브 AI 기능에 사용하는 1,000C` | [credit-1000.png](../../../qa/evidence/apps-in-toss-iap-products/credit-1000.png) | 승인 대기 | 업로드한 IAP 번들 | OFF |
| `credit-30000` | 소모품 | `크레딧 3,150C` | `기본 3,000C와 추가 150C를 지급해요` | [credit-3150.png](../../../qa/evidence/apps-in-toss-iap-products/credit-3150.png) | 승인 대기 | 업로드한 IAP 번들 | OFF |
| `credit-50000` | 소모품 | `크레딧 5,500C` | `기본 5,000C와 추가 500C를 지급해요` | [credit-5500.png](../../../qa/evidence/apps-in-toss-iap-products/credit-5500.png) | 승인 대기 | 업로드한 IAP 번들 | OFF |
| `credit-100000` | 소모품 | `크레딧 11,500C` | `기본 10,000C와 추가 1,500C를 지급해요` | [credit-11500.png](../../../qa/evidence/apps-in-toss-iap-products/credit-11500.png) | 승인 대기 | 업로드한 IAP 번들 | OFF |

공급가는 현재 앱의 5,000·10,000원 표기를 그대로 입력하는 값이 아니다. 콘솔이 VAT 포함 판매가를 자동 계산하므로 첫 상품 하나에서 계산 결과를 확인한 뒤 다섯 단계의 최종 판매가를 제품·재무 담당자가 승인한다. 상품 이미지 5종은 1024 × 1024px PNG와 수정 가능한 SVG로 준비했으며 파일 해시는 [상품 이미지 증거](../../../qa/evidence/apps-in-toss-iap-products/README.md)에 기록했다. 로컬 자산 준비와 콘솔 업로드 완료는 별도 상태로 관리한다.
...
| 콘솔 매니페스트 | `.ait` SHA·배포 ID·앱 이름, 상품 SKU·가격·문구·이미지·노출·최소 지원 버전 | 검증기 4건 통과; 실제 콘솔 값 입력 전 템플릿은 의도적으로 실패 |
...
7. 예시 매니페스트를 증거 폴더에 복사해 실제 콘솔 값을 기록하고 `make iap-release-check` 통과 결과를 보관한다.
...
10. 실제 발급 SKU를 환경 변수에 연결하고 SDK `displayAmount`와 콘솔 VAT 포함 판매가를 대조한다.
